...
import { reflowParagraph } from './factories'
...
// ═══════════════════════════════════════════════════════════
// 4 Reflow Paragraphs, RIGHT of notebook (x: 30)
//   - rf-1, rf-2 → DRAGGABLE  (bold, pinned=false via factory option)
//   - rf-3, rf-4 → PINNED     (regular weight, pinned=true)
// Each para's leading words tell its status: "DRAG ME —" vs "PINNED —"
// ═══════════════════════════════════════════════════════════
export const DOODLES: EntityDef[] = [
  reflowParagraph({
    id: 'rf-1', x: 32.5, y: 17, rotate: -5,
    maxWidth: 340, draggable: true,
